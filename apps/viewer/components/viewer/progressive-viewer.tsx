...
export function ProgressiveViewer({ initialMeetingData, apiKey, botId }: ProgressiveViewerProps) {
  const { meetingData, isLoadingTranscripts, transcriptsLoaded, error, retryLoading } =
  ...
  return (
    <div className="relative">
      <Viewer meetingData={meetingData} isLoadingTranscripts={isLoadingTranscripts} />
